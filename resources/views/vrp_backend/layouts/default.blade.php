...
<div class="container body">
    <div class="main_container">
        <div class="col-md-3 left_col">
            ...
            @include('vrp_backend.layouts.partials.header')
            @include('vrp_backend.layouts.partials.navigation')
            <!-- /menu footer buttons -->
    ...
    @include('vrp_backend.layouts.partials.profile')
    <!-- page content -->
        <div class="right_col" role="main">
            @yield('content')
        </div>
        <!-- /page content -->
        @include('vrp_backend.layouts.partials.footer')
    </div>
</div>
<!-- Bootstrap -->
